...
const ListaStudenti = ({
  ...
  const { contrastColor, lightFirstColor, secondColor } = useColors();

  return (
    <Components.contentContainer>
      <Components.TopBar
        style={{
          height: isFilterOpen ? "285px" : "100px",
      ...
      >
        ...
        >
          ...
          <Components.DisponibilityContainer>
            <Components.DisponibilityButton
              onClick={() => handleButtonClick("verde")}
              style={{
                borderBottom: activeButtons.includes("verde")
                  ? "2px solid blue"
                  : null,
              }}
            >
            ...
            <Components.DisponibilityButton
              onClick={() => handleButtonClick("arancione")}
              style={{
                borderBottom: activeButtons.includes("arancione")
                  ? "2px solid blue"
                  : null,
              }}
            >
            ...
            <Components.VerticalSeparator />
            <Components.DisponibilityButton
              onClick={() => handleButtonClick("rosso")}
              style={{
                borderBottom: activeButtons.includes("rosso")
                  ? "2px solid blue"
                  : null,
              }}
            >
        ...
        {isFilterOpen ? (
          <Components.FilterContainer style={{ transition: "all 0.3s" }}>
            ...
            >
              <h5
                style={{ paddingTop: "20px", paddingLeft: "10px", margin: "0" }}
              >
                Indirizzi
              </h5>
          ...
          {filteredStudents.map((student, index) => (
            <Components.listItem key={index}>
              ...
              <Components.listItemInfo>
                <Components.listItemName>
                  {student.firstName} {student.lastName}
                </Components.listItemName>
                <Components.ListItemSkills>
                  {student.skills.map((skill) => (
                    <Components.ListItemSkill key={skill}>
                      {skill}
                    </Components.ListItemSkill>
                  ))}
                </Components.ListItemSkills>
              </Components.listItemInfo>
            </Components.listItem>
