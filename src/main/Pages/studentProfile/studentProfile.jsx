...
function PDFPreview() {
  ...
  return (
    <div>
      <Document file="./CV/exampleCV.pdf" onLoadSuccess={onDocumentLoadSuccess}>
        ...
        <Components.userInformations>
          ...
          <Components.studentSkills>
            {student.skills.map((skill) => (
              <Components.studentSkill key={skill}>
                {skill}
              </Components.studentSkill>
            ))}
          </Components.studentSkills>
        </Components.userInformations>
        <Components.AboutMe>
          Ciao! Sono uno sviluppatore appassionato con una passione per la
          programmazione e la risoluzione dei problemi. Ho esperienza in vari
          linguaggi e framework di programmazione e sono sempre desideroso di
          saperne di più. Credo nel potere del lavoro di squadra e mi piace
        ...
        <Components.leftContainer>
          <Components.MapAndAziendeContainer>
            ...
            <Components.AziendeWorkedContainer>
              <Components.MapTitle
                style={{ backgroundColor: `var(--firstColor)` }}
              >
                Esperienze
              </Components.MapTitle>
