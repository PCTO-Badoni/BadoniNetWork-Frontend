...
import { faChevronLeft, faChevronRight, faSave, faEye, faEyeSlash } from "@fortawesome/free-solid-svg-icons";
...
const Step2 = React.memo(({ deadlineDate, setDeadlineDate, nome, setNome, cognome, setCognome, indirizzo, setIndirizzo }) => (
    <>
        <LocalizationProvider dateAdapter={AdapterDayjs}>
            <Components.Form style={{ justifyContent: "start" }}>
                <label htmlFor="name">Nome</label>
                <Components.Input type="name" placeholder="es. Mario" value={nome} onChange={(e) => setNome(e.target.value)} required />
                <label htmlFor="name">Cognome</label>
                <Components.Input type="name" placeholder="es. Rossi" value={cognome} onChange={(e) => setCognome(e.target.value)} required />
            ...
            <Components.Container>
                <Components.AziendaContainer signingIn={signIn}>
                    {isSending ? (
                        ...
                        <Components.Form onSubmit={handleSubmitAzienda} style={{ padding: "200px 50px" }}>
                ...
                >
                    {isRegisterClicked && (
                        <div className="progress-bar">
                            <div className="progress-bar-fill" style={{ width: `${((activeStep + 1) / steps.length) * 100}%` }}></div>
                ...
                >
                    <Components.Overlay signingIn={signIn}>
                        <Components.LeftOverlayPanel signingIn={signIn}>
                            ...
                            <Components.Paragraph>Sei unæ student? Clicca qui sotto!</Components.Paragraph>
                        ...
                        <Components.RightOverlayPanel signingIn={signIn}>
                            ...
                            <Components.Paragraph>Sei un'azienda? Clicca qui sotto!</Components.Paragraph>
                            <Components.GhostButton onClick={() => toggle(false)}>Azienda</Components.GhostButton>
